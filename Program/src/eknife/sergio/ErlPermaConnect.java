...
public class ErlPermaConnect {
	...
	private void openServer() throws Exception
	{
		...
		final String command = "/Users/serperu/Desktop/Dropbox/UPV/ProgramSlicing(MagicToolSeparado)/e-knife/e-KnifeLastVersion/Launcher/erl.sh " + "servernode"+this.id+" "+"homer"+this.id; // Esta ruta varía entre máquinas
		// Aqui se obtiene la ruta de ejecucion
		final File launcherFile = new File("/Users/serperu/Desktop/Dropbox/UPV/ProgramSlicing(MagicToolSeparado)/e-knife/e-KnifeLastVersion/Launcher/");
