...
%-- AUTHORS: 	 Anonymous
%-- DATE:        2016           
%-- PUBLISHED:   Software specially developed to test compression and decompression of
%-- 			 complex structures.
...
%-- DESCRIPTION
%-- This benchmark consists in a program with a database of singer. It returns a set
%-- of information of each singer (Name,Age,Last Album Name, and Location and Year of his 
%-- next concerte) by receiving a number between 1 and 6 as input.
%-----------------------------------------------------------------------------------------
%-----------------------------------------------------------------------------------------
-module(code).
-export([main/1]).
