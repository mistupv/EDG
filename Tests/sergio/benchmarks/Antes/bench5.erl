...
%-- DESCRIPTION
%-- The benchmark has a function receiving two lists as inputs. These lists are processed 
%-- in a call using their elements in a case statement. Another function can be called 
%-- in the case using as input the tail of one of the lists.
%-----------------------------------------------------------------------------------------
%-----------------------------------------------------------------------------------------
