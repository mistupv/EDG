...
%-- AUTHORS:     ingydotnet
%-- DATE:        2014           
%-- PUBLISHED:   https://rosettacode.org/wiki/Miller%E2%80%93Rabin_primality_test#Erlang (2016)
%-- DESCRIPTION
%-- The program is a modification of the original one. It implements the Miller-Rabin primality
%-- test algorithm. The input should be a number, and the output will be a boolean displaying 
%-- the result of the test.
%----------------------------------------------------------------------------------------------
%----------------------------------------------------------------------------------------------

-module(test13).
-export([main/1, power/2]).
