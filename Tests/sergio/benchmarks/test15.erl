...
%-- DESCRIPTION
%-- The program perform translations and operations with balanced ternary. Its inputs are
%-- two numbers in balanced ternary representation and a decimal number. It converts the 
%-- three numbers to the oposite representation and perform an operation with their 
