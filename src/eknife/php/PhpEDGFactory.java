...
public class PhpEDGFactory extends EDGFactory
{
	...
	private void process(ClassStatementContext context, Map<String, Object> info)
	{
		...
		if (!variableInitializers.isEmpty())
		{
			...
			if (initializer == null)
			{
				...
				super.addVariable(name, true, false, true, true, ldNodeInfo);
			}
			else
			{
				final LDASTNodeInfo ldNodeInfo0 = new LDASTNodeInfo(0, "var");
				final Variable variable0 = new Variable(varName, true, true, false, ldNodeInfo0);
	...
	private void process(FormalParameterContext context, Map<String, Object> info)
	{
		...
		super.addVariable(name, true, false, true, false, ldNodeInfo);
	}
	...
	private void process(ChainContext context, Map<String, Object> info)
	{
		...
		if (chainBase != null && memberAccess != null)
		{
			...
			{
				final LDASTNodeInfo ldNodeInfo = new LDASTNodeInfo(0, "var");
				super.addVariable(context.getText(), false, false, true, true, ldNodeInfo);
			}
		}
		else if (chainBase != null)
		{
			final LDASTNodeInfo ldNodeInfo = new LDASTNodeInfo(0, "var");
			super.addVariable(chainBase.getText(), false, false, true, false, ldNodeInfo);
		}
	}
	...
	private static class Variable
	{
		...
		public Variable(TerminalNode node, boolean declaration, boolean definition, boolean use, LDASTNodeInfo ldNodeInfo)
		{
			this(node, null, declaration, definition, use, ldNodeInfo);
		}
		public Variable(TerminalNode node, String name, boolean declaration, boolean definition, boolean use, LDASTNodeInfo ldNodeInfo)
		{
			this.node = node;
			this.name = name;
