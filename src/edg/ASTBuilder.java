...
public class ASTBuilder
{
	...
	public static int addVariable(EDG edg, int parentId, Where where, String name, boolean declaration, boolean definition, boolean use, boolean global, LDASTNodeInfo info)
	{
		final Node parent = ASTBuilder.getParentNode(edg, parentId, where);
		final Node expression = ASTBuilder.addNode(edg, parent, NodeInfo.Type.Expression, "expression", null);
...
//			context = VariableInfo.Context.Use;
	...
	public static int addCall(EDG edg, int parentId, Where where, LDASTNodeInfo info) // TODO Añadir info al nodo result para encontrar declaraciones (necesita la clase)
	{
		final Node parent = ASTBuilder.getParentNode(edg, parentId, where);
		final Node expression = ASTBuilder.addNode(edg, parent, NodeInfo.Type.Expression, "expression", null);
