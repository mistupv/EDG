...
// TODO Borrar
//final HawickJamesSimpleCycles<EDG, Node> hjsc = new HawickJamesSimpleCycles<EDG, Node>(this.edg);
...
// TODO Revisar
	...
	protected List<Node> getVariables(String id, Boolean declaration, VariableInfo.Context context, Boolean global)
	{
		...
		for (Node variable : variables)
		{
			...
			if (id != null && !variableId.equals(id))
				continue;
			if (declaration != null && info.isDeclaration() != declaration)
				continue;
